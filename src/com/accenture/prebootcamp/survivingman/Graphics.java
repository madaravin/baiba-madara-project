...
public class Graphics {
    ...
    public static void countRight2() {
    ...
    public static void countRight3() {
    ...
    public static void countRight4() {
    ...
    public static void countRight5() {
    ...
    public static void countRight6() {
    ...
    public static void countRight7() {
    ...
    public static void countRight8() {
    ...
    public static void countRight9() {
    ...
    public static void countWrong1() {
        ...
        System.out.println("                                                                         ");
        System.out.println();
        System.out.println("You have 6 tries left to guess the word.");
        System.out.println();
    }

    public static void countWrong2() {
        ...
        System.out.println("" +
                ...
                "   \\ \\|");
        System.out.println();
        System.out.println("You have 5 tries left to guess the word.");
        System.out.println();
    }

    public static void countWrong3() {
        ...
        System.out.println(" " +
                ...
                "     /  ``'._-''-_.'``  \\");
        System.out.println();
        System.out.println("You have 4 tries left to guess the word.");
        System.out.println();
    }

    public static void countWrong4() {
        ...
        System.out.println("/.-./.--.|.--.\\          /.--.|.--.\\.-.| ");
        System.out.println();
        System.out.println("You have 3 tries left to guess the word.");
        System.out.println();
    }

    public static void countWrong5() {
        ...
        System.out.println("         ,sSS.SSs,\n" +
                ...
                "         S `---' S  ");
        System.out.println();
        System.out.println("You have 2 tries left to guess the word.");
        System.out.println();
    }

    public static void countWrong6() {
        ...
        System.out.println("                         ..,co88oc.oo8888cc,..\n" +
                ...
                "                                                             . : :.:::::::.: :.\n");
        System.out.println();
        System.out.println("You have 1 try left to guess the word.");
        System.out.println();
    }

    public static void countWrong7() {
